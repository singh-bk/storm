 ...
 */
public class JedisAdvancedContainerBuilder {
     ...
     */
    public static JedisAdvancedInstanceContainer build(JedisPoolConfig config) {
        ...
        return new JedisAdvancedContainer(jedisPool);
    }
     ...
     */
    /*
    public static JedisAdvancedInstanceContainer build(JedisClusterConfig config) {
        ...
        return new JedisAdvancedClusterContainer(jedisCluster);
    }
    */
}

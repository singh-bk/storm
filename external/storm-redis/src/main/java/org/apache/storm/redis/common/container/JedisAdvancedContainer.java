 ...
 */
public class JedisAdvancedContainer implements JedisAdvancedInstanceContainer, Closeable {
    private static final Logger LOG = LoggerFactory.getLogger(JedisAdvancedContainer.class);
     ...
     */
    public JedisAdvancedContainer(JedisPool jedisPool) {
